package com.travelplanner.odoo.config;


import com.travelplanner.odoo.security.JwtFilter;
import com.travelplanner.odoo.service.CustomUserDetailsService;
        ...
        return http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/home",
                                ...
                                "/api/auth/verify",
                                "/api/auth/refresh",
                                "/api/auth/logout").permitAll() // allow public endpoints
